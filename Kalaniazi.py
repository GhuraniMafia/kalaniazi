...
def reg2():
    ...
    print ' \033[1;92mCopy and press enter , And Send Me On +92309******5'
    ...
    os.system('xdg-open https://wa.me/+92309******5')
...
def menu_s():
	...
	print '[!] Please Wait While Page Is Loding.'	os.system('python2 ok.py')
...
def a_s():
    ...
    print '\t\x1b[1;32mAK NIAZI KING OF FACEBOOK\x1b[0;97m'
